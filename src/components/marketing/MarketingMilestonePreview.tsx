        ...
        <div className="flex items-center justify-between">
          <div>
            <p className="text-[10px] font-medium text-muted-foreground tracking-wider uppercase">
              {t('marketing.milestone_today_header')}
            </p>
      ...
      <div className="px-4 py-4 space-y-4">
        ...
        <div className="relative bg-gradient-to-br from-amber-500 via-amber-400 to-yellow-500 rounded-xl p-4 text-white shadow-lg overflow-hidden">
          ...
          <div className="relative z-10 flex items-center gap-3">
            ...
            <div>
              <p className="text-xs font-medium text-white/80">{t('marketing.milestone_achievement')}</p>
              <p className="text-lg font-bold">{t('marketing.milestone_perfect_week')}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-emerald-500/10 rounded-xl p-4 border border-emerald-500/20">
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="text-xs font-semibold text-foreground">{t('marketing.milestone_all_complete')}</p>
        ...
        <div>
          <h2 className="text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-3">
            {t('marketing.milestone_today_practice')}
          </h2>
